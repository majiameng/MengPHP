...
class Dir {
     ...
     */
    protected function listFile($pathname, $pattern = '*') {
     ...
     * @return array
     */
    protected function current($arr) {
        if (!is_array($arr)) {
            return false;
        }
        return current($arr);
     ...
     * @return void
     */
    protected function getList($directory) {
     ...
     * @return void
     */
    protected function delDir($directory, $subdir = true) {
     ...
     * @return void
     */
    protected function del($directory) {
        if (is_dir($directory) == false) {
            return false;
        }
        $handle = opendir($directory);
