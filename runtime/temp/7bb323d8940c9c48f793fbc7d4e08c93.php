<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"E:\phpstudy\WWW\my\meng/app/admin\view\index\index_page.php";i:1509678700;}*/ ?>
<title>管理控制台 -  Powered by <?php echo config('mengphp.name'); ?></title>
            ...
            <div class="layui-row">
                <div class="layui-col-xs12 layui-col-sm6 layui-col-md6">
                    <table class="layui-table" lay-skin="line">
                        ...
                        <tr>
                            <td>系统版本</td>
                            <td>MengPHP v<?php echo config('mengphp.version'); ?></td>
                        </tr>
                        <tr>
                            <td>服务器环境</td>
